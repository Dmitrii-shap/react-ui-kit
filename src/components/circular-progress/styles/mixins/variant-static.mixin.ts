...
const bottomProgressPoint = ((getAbsolutePercentage(1)) * getCircumference(
    circleViewBoxDimension, circleThickness));

const upperProgressPoint = ((getAbsolutePercentage(80)) * getCircumference(
    circleViewBoxDimension, circleThickness));
